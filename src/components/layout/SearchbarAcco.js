...
const Searchbar = () => {
  ...
  useEffect(()=>{
    var options = ["Madrid","Barcelona","Valencia","Sevilla","Zaragoza","Málaga","Murcia","Palma de Mallorca","Las Palmas","Bilbao","Alicante","Córdoba","Valladolid","Vigo","Gijón","A Coruña","Granada","Vitoria-Gasteiz","Elx","Oviedo","Santa Cruz","Cartagena","Jerez de la Frontera","Pamplona","Almería","Donostia-San Sebastián","Castellón de la Plana","Santander","Burgos","Salamanca"];
