      ...
      <div className='newAcco2-card'>
        <Card className='step2'>
          ...
          <Card.Body>
            ...
            <Row className='btns'>
              <Col>
                <Link to='/dashboard/add-accommodation-step-1'>Terug</Link>
              </Col>
              <Col>
                <Link to='/dashboard/add-accommodation-step-3'>Volgende</Link>
              </Col>
            </Row>
          </Card.Body>
        </Card>
