      ...
      <div className='newAcco3-card'>
        <Card className='step3/**'>
          ...
          <Card.Body>
            ...
            <Row className='btns'>
              <Col>
                <Link to='/dashboard/edit-accommodation-step-2'>Vorige</Link>
              </Col>
              <Col>
                <Link to='/dashboard/edit-accommodation-step-4'>Volgende</Link>
              </Col>
            </Row>
          </Card.Body>
        </Card>
